...
//Lazada
Route::get('/lazada/get_products', [LazadaController::class, 'getProducts'])->name('lazada.get_products');
Route::get('/lazada/get_orders', [LazadaController::class, 'getOrders'])->name('lazada.get_orders');